...
function BasicExample() {
  return (
    <>
      <h2 className="text-center my-5">F.A.Q.</h2>

      <Accordion className="my-5 col-10 col-md-8 mx-auto" defaultActiveKey="0">
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            ...
            d'apprentissage de la propreté ainsi que le repas & goûté pour ceux
            à qui je ne fournit pas ceci.
          </Accordion.Body>
        </Accordion.Item>
